...
//
// 折扣展示依据：PRD §14.3「产品选择页可保留折扣辅助展示」
//   - 打折产品：显示「打折 50%」橙底标签（产品申请管理菜单维护的折扣值）
//   - 不打折产品：依据 PRD §9.8-4「页面不单独展示折扣字段，仅展示'是否打折产品：是/否'」，
//     选择页不展示折扣标签
// mock 数据中 isDiscount: false 时 discount=1（业务口径"原价×1"），
// UI 视觉上无差异，金额计算由 calculateAmount() 按 isDiscount 分支处理
// ============================================================

...
export const mockBudgets: Budget[] = [
  {
    ...
    isAbnormal: false,
    applyType: '新品申请',
    applyReason: '季度新品推广活动，针对核心专卖店进行首批铺货支持',
  ...
  },
  {
    ...
    applicationAvailable: true,
    isAbnormal: true,
    abnormalMessage: '组织调整中，预算归属可能发生变更',
    applyType: '活动申请',
    applyReason: '618促销活动产品支持',
...
export const mockStores = [
  { code: '31692', name: '赵晋安 宋晓华' },
  { code: '31441', name: '赵晋杰' },
  { code: '31375', name: '大连瑞轩商贸有限公司' },
  { code: '31371', name: '沈阳迎续商贸有限公司' },
  { code: '37235', name: '游秋燕' },
  { code: '34998', name: '福州晋安第五小学专卖店 林志高' },
]
...
export const mockWorkOrderCards: WorkOrderCard[] = [
  ...
  },
  {
    ...
    applicantName: '赵六',
    applyType: '新品申请',
    applyReason: '新品区域推广支持',
    createTime: '06-23 16:45',
  },
]
...
const mockApprovalNodes: ApprovalNode[] = [
  {
    ...
    nodeType: 'start',
    handlerName: '张三',
    handlerTime: '2024-06-26 10:17:30',
    functionOrderNo: 'FO20240626001',
    functionOrderStatus: '已取消',
  },
  {
    id: 'node_1',
    nodeType: 'approval',
    handlerName: '李经理',
    handlerTime: '2024-06-26 11:30:00',
    result: '通过',
    remark: '同意，预算充足',
  },
  {
    ...
    nodeType: 'approval',
    handlerName: '王总监',
    handlerTime: '2024-06-26 14:00:00',
    result: '通过',
    remark: '审批通过',
    functionOrderNo: 'FO20240626001',
    functionOrderStatus: '已取消',
    relatedOrders: [
      { orderNo: 'O20240626001', orderType: '产品申请表订单', orderStatus: '已生成' },
    ],
  },
]
...
const mockGroupResults: GroupResult[] = [
  {
    ...
    functionOrderStatus: '已取消',
    relatedOrders: [
      { orderNo: 'O20240626001', orderType: '产品申请表订单', orderStatus: '已生成', remark: '-' },
    ],
  },
  {
    groupId: 'group_2',
    storeCode: '31441',
    storeName: '赵晋杰',
    functionOrderNo: 'FO20240626002',
    functionOrderStatus: '已取消',
    relatedOrders: [
      { orderNo: 'O20240626002', orderType: '内部申请表订单', orderStatus: '生成失败', remark: '客户信息不满足下单规则' },
    ],
    failReason: '客户信息不满足下单规则，请检查客户层级和资质',
  },
]
...
export const mockWorkOrderDetail: ProductWorkOrder = {
  id: '1',
  workOrderNo: 'PA202406260001',
  displayStatus: '处理中',
  applicantName: '张三',
  applicantOrg: '南大 / 福建',
  createTime: '2024-06-26 10:17:30',
  ...
  totalAmount: 3497.50,
  attachments: [
    { id: 'att_1', name: '新品推广方案.pdf', url: '#', type: 'pdf', size: 1024 * 1024 * 2 },
    { id: 'att_2', name: '专卖店清单.xlsx', url: '#', type: 'excel', size: 1024 * 512 },
  ],
...
export function calculateAmount(product: ProductItem): number {
  if (product.isDiscount) {
    return Number((product.jdePrice * product.quantity * product.discount).toFixed(2))
  }
